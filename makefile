...
OBJ_DIR = obj
SRC_DIR = src
TEST_OUT_DIR = bin/sorting-test

TARGET_OUT_NAME = sorting
TARGET = main

THIRDPARTY_DIR = thirdparty

TEST_SRC_DIR = test
TEST_OUT_NAME = sorting-test
TEST_OBJ_DIR = $(OBJ_DIR)/$(TEST_OUT_NAME)
TEST_OBJECTS = $(TEST_OBJ_DIR)/ctest.o $(TEST_OBJ_DIR)/main.o

APP_PATH = $(BIN_DIR)/$(APP_NAME)
LIB_PATH = $(BIN_DIR)/lib.a
LIB_OBJ_DIR = obj/src/lib
LIB_HEADERS_DIR = $(SRC_DIR)/lib
...
clean:
	...
	rm -rf $(OBJ_DIR)/sorting/*.o $(OBJ_DIR)/sorting/*.d
	rm -rf $(OBJ_DIR)/sorting-test/*.o $(OBJ_DIR)/sorting-test/*.d
